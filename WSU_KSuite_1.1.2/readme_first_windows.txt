...
To use this program, double-click on the icon for the win_console.bat file.  This
...
Double-click on the icon for win_console.bat to open a console window.  Once the
...
compiler script - it's called win_compile.bat.  When you use this program, it'll compile
...
1) Open a console window (by double-clicking on the win_console.bat icon)
2) Run win_compile, giving it the name of the controller (without the .Java extension)
   Here's what you need to type:

            win_compile basic_reactive
...
console window (one you opened using win_console.bat):
